...
public class PruebaMiInstituto
{
    ...
    {
        GeneradorDeLog gl1 = new GeneradorDeLog();
        
        // define e inicializa una variables de tipo "MiInstituto" 
        ...
        //invoca al método "calcularSueldo" para todos los empleados,
        //el mes a calcular es junio
        d1.calcularSueldo(06);
        d2.calcularSueldo(06);
        d3.calcularSueldo(06);
        di1.calcularSueldo(06);
        di2.calcularSueldo(06);
        a1.calcularSueldo(06);
        a2.calcularSueldo(06);        
        ...
        // invoca al método “imprimirPersonasOrdenNatural” de la clase
        // “Institucion” para listar los datos de la lista "personas"
        // ordenadas por nombre.
        i1.imprimirPersonasOrdenNatural();
    }
}
