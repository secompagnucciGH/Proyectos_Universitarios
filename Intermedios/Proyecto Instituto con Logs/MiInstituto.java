...
public class MiInstituto
{
    ...
    // se define la colección de tipo "List" para
    // que pueda utilizarse cualquiera de 
    ...
    public MiInstituto()
    {
        ...
        // se implementa con LinkedList para verificar
        // que funciona en forma similar a ArrayList
    ...
    /**
     * Método imprimirPersonasOrdenNatural 
     * Ordena la lista completa de personas por nombre
     * y luego las imprime utilizando en método toString.
     */
    public void imprimirPersonasOrdenNatural()
    {
        //invoca al método "sort" de la clase Collections
        //para ordenar las personas por nombre.
        Collections.sort(personas);
        System.out.println("===========================================");
        System.out.println("Listado personas en orden natural (nombre) ");
        System.out.println("===========================================");
        imprimirTodas();
    }

    /**
     * Método imprimirTodas 
     */
